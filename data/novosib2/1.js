...
lines['novosib2']['1'] = [
	{
		...
		signals: [
			...
			{ joint: '411', name: 'БР-411', lenses: 'WBY-YYG-Rw' },
		],
		switches: [
	...
	},
	{
		...
		joints: [
			{ x: 67 - 75, name: '379' },
			{ x: 67, name: '411', limit: 60, later: { 60: 3 } },
			{ x: 67 + 75, name: '413', limit: 60, later: { 40: 1 } },
			{ x: 67 + 75 + 75, name: '415', limit: 60, later: { 40: 1 } },
			{ x: 67 + 75 + 75 + 125, name: '417', limit: 70, later: { 70: 3 } },
			{ x: 1117 - 75 - 75 - 75 - 150 - 150, name: '469', limit: 70, later: { 70: 2 } },
			{ x: 1117 - 75 - 75 - 75 - 150, name: '471', limit: 70, later: { 60: 1 } },
			{ x: 1117 - 75 - 75 - 75, name: '473', limit: 60 },
	...
	},
	{
		...
		joints: [
			...
			{ x: -3 + 75, name: '511', limit: 60, later: { 60: 3 } },
			{ x: -3 + 75 + 75, name: '513', limit: 70, later: { 40: 1 } },
			{ x: -3 + 75 + 75 + 75, name: '515', limit: 70, later: { 40: 1 } },
			{ x: -3 + 75 + 75 + 75 + 150, name: '517', limit: 70 },
			{ x: -3 + 75 + 75 + 75 + 75 + 850 - 75 - 75 - 75 - 125 - 150, name: '569', limit: 60 },
			{ x: -3 + 75 + 75 + 75 + 75 + 850 - 75 - 75 - 75 - 125, name: '571', limit: 70 },
	...
	},
	{
		...
		joints: [
			...
			{ x: -9 + 75, name: '611', limit: 60, later: { 60: 3 } },
			{ x: -9 + 75 + 75, name: '613', limit: 70, later: { 40: 1 } },
			{ x: 240, name: '615', limit: 70 },
			{ x: 240 + 75, name: '617', limit: 80 },
			// { x: 839, name: 'ПРС №5', limit: 0 },
			{ x: 863 - 275, name: '665', limit: 80 },
			{ x: 863, name: '667', later: { 80: 2 } },
			{ x: 1525.8 - 75 - 100 - 150 - 150, name: '669', limit: 60, later: { 70: 2 } },
